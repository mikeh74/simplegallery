(()=>{let e=(e,t,l,a,r=null)=>{let i="",s="";return null!==r&&(i=`data-youtubeid="${r}"`,s=`<div class="simple-gallery-play-icon">
    ...
    </li>`},t=(t,l)=>{let a=[];return t.forEach((t,l)=>{a.push(function(t,l){var a,r;t.setAttribute("data-imagekey",l);let i=t.getAttribute("data-sg-youtubeid"),s=(a=t).getAttribute("data-sg-src")?a.getAttribute("data-sg-src"):a.src,n=(r=t).getAttribute("data-sg-desc")?r.getAttribute("data-sg-desc"):r.alt;return e(l,s,t.alt,n,i)}(t,l))}),`    <ul data-gallery-id="${l}" class="gallery-list">
      ${a.join("")}
    </ul>`},l=e=>`
  ...
  </div>`,a={galleryId:"",images:[],currentImage:0,modalImages:[],totalImages:0},r=e=>{let r=document.querySelectorAll(e),i=[];r.forEach(e=>{let l=e.id,r=Object.create(a);r.images=e.querySelectorAll("img");let s=t(r.images,l);i.push(s)});let s=l(i.join(""));document.body.insertAdjacentHTML("beforeend",s)};window.onYouTubeIframeAPIReady=()=>{!function(){let e=window.YT,t=e=>{e.target.playVideo()};document.querySelectorAll("#simple-gallery [data-youtubeid]").forEach(function(l){l.addEventListener("click",function(l){l.preventDefault();let a=l.currentTarget.getAttribute("data-youtubeid");if(""!==a){window.player=new e.Player("ytplayer",{height:"390",width:"640",videoId:a,events:{onReady:t},playerVars:{rel:0,autoplay:1}});let r=document.querySelector("#simple-gallery #ytplayer");r.parentNode.classList.add("ytplayer-active"),r.parentNode.parentNode.classList.add("ytactive"),l.currentTarget.classList.remove("image-active","slide-in-from-right","slide-in-from-left")}})})}()};var i=({selector:e=".gallery"}={})=>{document.querySelectorAll(e).length>0&&(r(e),function(e){let t=document.getElementById("simple-gallery"),l=document.querySelectorAll(`${e} img`),a=0,r=null,i=t.querySelectorAll(".gallery-list img"),s=0;function n(){c(),t.classList.remove("gallery-active"),document.body.style.overflow="auto";let e=`[data-gallery-id='${r}']`;t.querySelectorAll(e)[0].classList.remove("gallery-list--active"),r=null}function o(){g(a=u(parseInt(a,10)+1))}function d(){g(a=u(parseInt(a,10)-1),"right")}function c(){let e=window.player;if(t.querySelectorAll(".gallery-list li").forEach(function(e){e.classList.remove("image-active","slide-in-from-right","slide-in-from-left")}),void 0!==e){let t=document.querySelector("#simple-gallery #ytplayer");t.parentNode.classList.remove("ytplayer-active"),t.parentNode.parentNode.classList.remove("ytactive"),null!==e.getIframe()&&e.destroy()}}function g(e,l){l=void 0!==l?l:"left",c();let a=t.querySelector(`.gallery-list[data-gallery-id="${r}"] [data-imagekey="${e}"]`);a.classList.add("image-active"),"right"===l?a.classList.add("slide-in-from-right"):a.classList.add("slide-in-from-left"),t.classList.add("gallery-active"),document.body.style.overflow="hidden";let i=`[data-gallery-id='${r}']`;t.querySelectorAll(i)[0].classList.add("gallery-list--active")}function u(e){return e<0?s-1:e>s-1?0:e}l.forEach(function(t){t.addEventListener("click",l=>{l.preventDefault(),c(),r=t.closest(e).id,s=document.querySelectorAll(`[data-gallery-id="${r}"] img`).length;let i=t.getAttribute("data-imagekey");a=i,g(i)})}),i.forEach(e=>{var t,l,a;let r,i;t=e,l=d,a=o,r=0,i=0,t.addEventListener("mousedown",e=>{e.preventDefault(),r=e.screenX}),t.addEventListener("mouseup",e=>{(i=e.screenX)>r+50?l():i<r-50&&a()}),t.addEventListener("touchstart",e=>{r=e.changedTouches[0].screenX}),t.addEventListener("touchend",e=>{(i=e.changedTouches[0].screenX)>r+50?l():i<r-50&&a()})}),t.addEventListener("click",e=>{e.target===t&&n()}),document.querySelector(".simple-gallery-button-close").addEventListener("click",e=>{e.preventDefault(),n()}),document.addEventListener("keydown",e=>{if(t.classList.contains("gallery-active"))switch(e.key){case"Escape":case"Esc":n();break;case"ArrowRight":case"Right":o();break;case"ArrowLeft":case"Left":d()}}),t.querySelector(".simple-gallery-button-previous").addEventListener("click",e=>{e.preventDefault(),d()}),t.querySelector(".simple-gallery-button-next").addEventListener("click",e=>{e.preventDefault(),o()})}(e),function(){let e=document.createElement("script");e.id="iframe-api",e.src="https://www.youtube.com/iframe_api";let t=document.getElementsByTagName("script")[0];t.parentNode.insertBefore(e,t)}())};i(),window.simpleGallery=i})();
